...
export default {
  ...
  methods: {
    ...
    forget() {
      this.$prompt("请输入邮箱，以便您收到更改密码信息", "提示", {
        confirmButtonText: "嗯嗯好的",
        cancelButtonText: "想起来了",
        inputPattern:
          /[\w!#$%&'*+/=?^_`{|}~-]+(?:\.[\w!#$%&'*+/=?^_`{|}~-]+)*@(?:[\w](?:[\w-]*[\w])?\.)+[\w](?:[\w-]*[\w])?/,
...
.container:before {
  ...
  background-image: linear-gradient(-45deg, #6c63ff 0%, #04befe 100%);
